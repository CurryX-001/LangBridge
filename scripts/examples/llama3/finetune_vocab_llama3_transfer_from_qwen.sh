...
LOG_DIR="./checkpoints/llama3_it_8b_it_vocab_19200_dim_5120_finetune_mmvocab_with_qwen2_0.5b_it_vocab_19200_dim_5120_finetuned_mlp"
mkdir -p ${LOG_DIR}
# Set log file path
...
torchrun --nnodes=1 --nproc_per_node=8 --master_addr=localhost --master_port=6105 llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/qwen2_0.5b_it_vocab_19200_dim_5120_finetune_mm_projector.bin \
    ...
    --mm_vocab_matrix "./embeddings/Meta-Llama-3-8B-Instruct_embedding_matrix_19200.pt"
