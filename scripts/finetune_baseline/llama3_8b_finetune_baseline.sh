...
torchrun \
  ...
  /mnt/petrelfs/mengfanqing/LLaVA_vocab/LLaVA-main/llava/train/train_mem.py \
    --deepspeed /mnt/petrelfs/mengfanqing/LLaVA_ori_1104/LLaVA-main/scripts/zero3.json \
    --model_name_or_path /mnt/petrelfs/share_data/wangwenhai/llm/Meta-Llama-3-8B-Instruct \
    --version llama3 \
    ...
    --bf16 True \
    --output_dir ./checkpoints/Llama-3-8B-finetune \
    --num_train_epochs 1 \
