...
# 创建输出目录，目录名称为脚本名称
OUTPUT_DIR="/mnt/petrelfs/mengfanqing/LLaVA_vocab/LLaVA-main/llava/output/$SCRIPT_NAME"
mkdir -p $OUTPUT_DIR
...
srun -p MoE -c 48 --gres=gpu:8 --async --quotatype=auto --output=$SBATCH_OUTPUT_PATH \
    sh $SCRIPT_PATH
