...
class ModelArguments:
    ...
    mlp_hidden_size: Optional[int] = field(default=5120)
    mm_vocab_size: Optional[int] = field(default=19200)
    mm_vocab_matrix: Optional[str] = field(default=None)
...
class DataCollatorForSupervisedDataset(object):
    ...
    def __call__(self, instances: Sequence[Dict]) -> Dict[str, torch.Tensor]:
        ...
        if self.tokenizer.pad_token_id is None:
            # self.tokenizer.pad_token_id = self.tokenizer.eos_token_id  #from llava-next
...
def train(attn_implementation=None):
    ...
    if 'mpt' in model_args.model_name_or_path:
        ...
        tokenizer = transformers.AutoTokenizer.from_pretrained(
            model_args.model_name_or_path, cache_dir=training_args.cache_dir, model_max_length=training_args.model_max_length, padding_side="right"
        )    
    else:
        tokenizer = transformers.AutoTokenizer.from_pretrained(
            model_args.model_name_or_path,
    ...
    if model_args.version == "v0":
        ...
        if model_args.version in conversation_lib.conv_templates:
            ...
            print(f"Using conversation format: 'vicuna_v1'")
