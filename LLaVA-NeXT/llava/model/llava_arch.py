...
class LlavaMetaModel:
    ...
    def initialize_vision_modules(self, model_args, fsdp=None):
        ...
        self.config.mlp_hidden_size =  getattr(model_args, 'mlp_hidden_size')
        self.config.mm_hidden_size = getattr(vision_resampler, "hidden_size", vision_tower.hidden_size)
        self.config.mm_vocab_size =  getattr(model_args, 'mm_vocab_size')
        self.config.mm_vocab_matrix= getattr(model_args, 'mm_vocab_matrix')
