...
torchrun \
  ...
  /mnt/petrelfs/mengfanqing/Codebook/llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter /mnt/petrelfs/mengfanqing/Codebook/checkpoints/llama3_8b_pretrain_vocab12800_2-1024-1e-3/mm_projector.bin\
    ...
    --mm_vocab_matrix "/mnt/petrelfs/mengfanqing/Codebook/embedding_matrix_llm/Meta-Llama-3-8B-Instruct_embedding_matrix_12800_random.pt"