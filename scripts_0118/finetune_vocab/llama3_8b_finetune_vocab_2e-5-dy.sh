...
torchrun \
  ...
  /mnt/petrelfs/mengfanqing/Codebook/llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter /mnt/petrelfs/mengfanqing/Codebook/checkpoints/Llama-3-8B-pretrain-3-vocab19200-2e-5/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir /mnt/hwfile/gveval/mfq/checkpoints/Llama-3-8B-finetune-vocab19200-2e-5-dy \
    --num_train_epochs 1 \
