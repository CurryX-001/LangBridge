...
model_path = "/mnt/petrelfs/mengfanqing/Codebook/checkpoints/Qwen2-0.5B-finetune_vocab/model.safetensors"
...
output_path = "/mnt/petrelfs/mengfanqing/Codebook/checkpoints/Qwen2-0.5B-finetune_vocab/mm_projector.bin"
