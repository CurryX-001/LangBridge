...
torchrun \
  ...
  /mnt/petrelfs/mengfanqing/Codebook/llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter /mnt/petrelfs/mengfanqing/Codebook/checkpoints/Llama-3-8B-pretrain-baseline-2e-5/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir /mnt/hwfile/gveval/mfq/checkpoints/Llama-3-8B-finetune-2e-5-ross \
    --num_train_epochs 1 \
