...
torchrun \
  ...
  /mnt/petrelfs/mengfanqing/LLaVA_vocab/LLaVA-main/llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/Qwen2-7B-pretrain \
    --num_train_epochs 1 \
    ...
    --mm_vocab_matrix "/mnt/petrelfs/mengfanqing/MM_vocab/embedding_matrix_vocab_19200/Qwen2-7B-Instruct_embedding_matrix_vocab_19200.pt"